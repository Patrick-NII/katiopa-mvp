    ...
    <div className="absolute inset-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden">
      <div className="h-full overflow-y-auto p-4 md:p-5 lg:p-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 text-center">
          ...
          <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Score total</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 text-center">
          ...
          <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Série actuelle</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 text-center">
          ...
          <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Étoiles</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow cursor-pointer">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Niveau {currentLevel}</p>
            </div>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-500 dark:text-gray-400">Progression: 80%</span>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow cursor-pointer">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white">Débogage</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300">Niveau {currentLevel}</p>
            </div>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-500 dark:text-gray-400">Progression: 60%</span>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow cursor-pointer">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white">Logique</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300">Niveau {currentLevel}</p>
            </div>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-500 dark:text-gray-400">Progression: 30%</span>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 mb-8">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Défi du jour</h2>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-xl p-6 border border-green-200 dark:border-green-700">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-gray-600 dark:text-gray-300">Temps: 5 min</span>
            </div>
            <div className="flex items-center space-x-2">
              <Trophy className="w-4 h-4 text-green-600 dark:text-green-400" />
              <span className="text-sm text-gray-600 dark:text-gray-300">Bonus: +75 points</span>
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 mb-8">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Éditeur de code</h2>
        </div>
        ...
        <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
          <h4 className="font-medium text-gray-900 dark:text-white mb-2">Sortie :</h4>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Mes récompenses</h2>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center">
            ...
            <p className="text-sm font-medium text-gray-900 dark:text-white">Premier code</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">Programme créé</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm font-medium text-gray-900 dark:text-white">Debugger</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">10 bugs corrigés</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm font-medium text-gray-900 dark:text-white">En progression</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">3 jours consécutifs</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Prochain objectif</p>
            <p className="text-xs text-gray-400 dark:text-gray-500">Niveau 2</p>
          </div>
        </div>
      </div>
      </div>
