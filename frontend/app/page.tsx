      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <svg className="w-6 h-6 text-gray-600 group-hover:text-blue-600 group-hover:scale-110 transition-all duration-300" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a 
              ...
              style={{ backgroundColor: '#f3f4f6 !important' }}
            >
              <svg className="w-6 h-6 text-gray-600 group-hover:text-pink-600 group-hover:scale-110 transition-all duration-300" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a 
              ...
              style={{ backgroundColor: '#f3f4f6 !important' }}
            >
              <svg className="w-6 h-6 text-gray-600 group-hover:text-blue-700 group-hover:scale-110 transition-all duration-300" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a 
              ...
              style={{ backgroundColor: '#f3f4f6 !important' }}
            >
              <svg className="w-6 h-6 text-gray-600 group-hover:text-red-600 group-hover:scale-110 transition-all duration-300" fill="currentColor" viewBox="0 0 24 24">
