...
import type { Message, LinkAction, KBItem } from './lib/types'
import { detectIntent, tokenize, normalize } from './lib/nlu'
...
const LINKS = {
  ...
  login: '/login',
  contact: '/contact',
  mathcube: '/products/mathcube',
  codecube: '/products/codecube',
  playcube: '/products/playcube',
  docs: '/docs',
}
  ...
  useEffect(()=>{
    ...
    ;(async()=>{
      const files = [
        '/data/kb_site.json',
        '/data/kb_pedago.json',
        '/data/kb_fun_kids.json',
        '/data/kb_mini_lessons.json',
        '/data/kb_science_facts.json',
        '/data/kb_reading_stories.json',
        '/data/kb_math_problems.json'
      ]
      const all: KBItem[] = []
